...
from services.flight_simulation import generate_simulated_flights
...
def get_iata_code(city_name: str) -> str:
    ...
    from services.flight_simulation import CITY_COORDINATES
...
def search_flights(
    ...
    for f in flights_list:
        flight_id = db_connection.execute_query(
            "INSERT INTO flights (airline, source_city, destination_city, departure_time, arrival_time, price) VALUES (?, ?, ?, ?, ?, ?)",
